...
if ($_GET["id"]) {
  ...
  if (mysqli_num_rows($result) == 1) {
    ...
    $author_fname = $media["author_first_name"];
    $author_lname = $media["author_last_name"];
    $publisher = $media["publisher_name"];
    $edition = $media["edition_year"];
    $cover = $media["cover"];
  } else {
...
<body class="bg-dark text-white">
  <div class="container my-4">
    <fieldset class="mx-auto">
      ...
      <p>
        <b>Author:</b> <?=$author_fname?> <?=$author_lname?><br>
        <b>Title:</b> <?=$title?> <?=$subtitle?><br>
        <b>Publisher:</b> <?=$publisher?> <?=$edition?><br>
      </p>
